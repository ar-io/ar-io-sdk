...
import { hashAsyncIterableToB64Url } from './hash.js';

describe('hashAsyncIterableToB64Url', { timeout: 5000 }, () => {
  ...
  it('should hash a Node.js Readable stream correctly', async () => {
    ...
    const result = await hashAsyncIterableToB64Url(stream);
  ...
  it('should hash a Node.js Readable stream with a different algorithm', async () => {
    ...
    const result = await hashAsyncIterableToB64Url(stream, 'sha512');
  ...
  it('should correctly hash large streams in chunks', async () => {
    ...
    const nodeResult = await hashAsyncIterableToB64Url(nodeStream);
    ...
    const webResult = await hashAsyncIterableToB64Url(webStream);
