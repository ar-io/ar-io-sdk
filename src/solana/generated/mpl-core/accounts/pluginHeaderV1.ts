...
import { assertAccountExists, assertAccountsExist, combineCodec, decodeAccount, fetchEncodedAccount, fetchEncodedAccounts, getStructDecoder, getStructEncoder, getU64Decoder, getU64Encoder, type Account, type Address, type EncodedAccount, type FetchAccountConfig, type FetchAccountsConfig, type FixedSizeCodec, type FixedSizeDecoder, type FixedSizeEncoder, type MaybeAccount, type MaybeEncodedAccount } from '@solana/kit';
...
export function decodePluginHeaderV1<TAddress extends string = string>(encodedAccount: EncodedAccount<TAddress>): Account<PluginHeaderV1, TAddress>;
export function decodePluginHeaderV1<TAddress extends string = string>(encodedAccount: MaybeEncodedAccount<TAddress>): MaybeAccount<PluginHeaderV1, TAddress>;
export function decodePluginHeaderV1<TAddress extends string = string>(encodedAccount: EncodedAccount<TAddress> | MaybeEncodedAccount<TAddress>): Account<PluginHeaderV1, TAddress> | MaybeAccount<PluginHeaderV1, TAddress> {
