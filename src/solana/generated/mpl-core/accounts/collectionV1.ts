...
import { addDecoderSizePrefix, addEncoderSizePrefix, assertAccountExists, assertAccountsExist, combineCodec, decodeAccount, fetchEncodedAccount, fetchEncodedAccounts, getAddressDecoder, getAddressEncoder, getStructDecoder, getStructEncoder, getU32Decoder, getU32Encoder, getUtf8Decoder, getUtf8Encoder, type Account, type Address, type Codec, type Decoder, type EncodedAccount, type Encoder, type FetchAccountConfig, type FetchAccountsConfig, type MaybeAccount, type MaybeEncodedAccount } from '@solana/kit';
import { getKeyDecoder, getKeyEncoder, type Key, type KeyArgs } from '../types/index.js';



export type CollectionV1 = { key: Key; updateAuthority: Address; name: string; uri: string; numMinted: number; currentSize: number;  };

export type CollectionV1Args = { key: KeyArgs; updateAuthority: Address; name: string; uri: string; numMinted: number; currentSize: number;  };
...
export function decodeCollectionV1<TAddress extends string = string>(encodedAccount: EncodedAccount<TAddress>): Account<CollectionV1, TAddress>;
export function decodeCollectionV1<TAddress extends string = string>(encodedAccount: MaybeEncodedAccount<TAddress>): MaybeAccount<CollectionV1, TAddress>;
export function decodeCollectionV1<TAddress extends string = string>(encodedAccount: EncodedAccount<TAddress> | MaybeEncodedAccount<TAddress>): Account<CollectionV1, TAddress> | MaybeAccount<CollectionV1, TAddress> {
